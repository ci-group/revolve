...
void InitDefaultsBodyAnalysisResponseImpl() {
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_sdf_5fbody_5fanalyze_2eproto::InitDefaultsBoundingBox();
  protobuf_sdf_5fbody_5fanalyze_2eproto::InitDefaultsContact();
  {
...
void InitDefaultsBodyAnalysisResponse() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsBodyAnalysisResponseImpl);
}
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "sdf_body_analyze.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
// @@protoc_insertion_point(message_clear_start:revolve.msgs.Contact)
  ...
  if (cached_has_bits & 3u) {
    if (cached_has_bits & 0x00000001u) {
      GOOGLE_DCHECK(!collision1_.IsDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited()));
      (*collision1_.UnsafeRawStringPointer())->clear();
    }
    if (cached_has_bits & 0x00000002u) {
      GOOGLE_DCHECK(!collision2_.IsDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited()));
      (*collision2_.UnsafeRawStringPointer())->clear();
    }
  }
  _has_bits_.Clear();
...
BodyAnalysisResponse::BodyAnalysisResponse()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_sdf_5fbody_5fanalyze_2eproto::InitDefaultsBodyAnalysisResponse();
  }
  SharedCtor();
...
BodyAnalysisResponse* BodyAnalysisResponse::New(::google::protobuf::Arena* arena) const {
  BodyAnalysisResponse* n = new BodyAnalysisResponse;
  if (arena != NULL) {
    arena->Own(n);
  }
  return n;
...
void BodyAnalysisResponse::SerializeWithCachedSizes(
  ...
  for (unsigned int i = 0,
    ...
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      2, this->contact(static_cast<int>(i)), output);
  }
...
::google::protobuf::uint8* BodyAnalysisResponse::InternalSerializeWithCachedSizesToArray(
  ...
  if (cached_has_bits & 0x00000001u) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        1, *this->boundingbox_, deterministic, target);
  }
