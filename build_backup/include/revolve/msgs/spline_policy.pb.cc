...
void InitDefaultsSpline() {
  ...
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsSplineImpl);
}
...
void InitDefaultsModifyPolicy() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsModifyPolicyImpl);
}
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "spline_policy.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
Spline::Spline()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_spline_5fpolicy_2eproto::InitDefaultsSpline();
  }
  SharedCtor();
...
Spline* Spline::New(::google::protobuf::Arena* arena) const {
  Spline* n = new Spline;
  if (arena != NULL) {
    arena->Own(n);
  }
...
Policy::Policy()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_spline_5fpolicy_2eproto::InitDefaultsPolicy();
  }
  SharedCtor();
...
ModifyPolicy::ModifyPolicy()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_spline_5fpolicy_2eproto::InitDefaultsModifyPolicy();
  }
  SharedCtor();
...
ModifyPolicy* ModifyPolicy::New(::google::protobuf::Arena* arena) const {
  ModifyPolicy* n = new ModifyPolicy;
  if (arena != NULL) {
    arena->Own(n);
  }
  return n;
