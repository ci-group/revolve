class Grid:
    ...
    def calculate_orientation(self):
        ...
        if (
            ...
            or (Grid.previous_move == 1 and Grid.orientation == 1)
            or (Grid.previous_move == 2 and Grid.orientation == 3)
            or (Grid.previous_move == 3 and Grid.orientation == 2)
            or (Grid.previous_move == 0 and Grid.orientation == 0)
        ):
            self.set_orientation(1)
        elif (
            (Grid.previous_move == 2 and Grid.orientation == 1)
            or (Grid.previous_move == 0 and Grid.orientation == 3)
            or (Grid.previous_move == 1 and Grid.orientation == 2)
            or (Grid.previous_move == 3 and Grid.orientation == 0)
        ):
            self.set_orientation(2)
        elif (
            (Grid.previous_move == 0 and Grid.orientation == 1)
            or (Grid.previous_move == 3 and Grid.orientation == 3)
            or (Grid.previous_move == 2 and Grid.orientation == 2)
            or (Grid.previous_move == 1 and Grid.orientation == 0)
        ):
            self.set_orientation(0)
        elif (
            (Grid.previous_move == 3 and Grid.orientation == 1)
            or (Grid.previous_move == 1 and Grid.orientation == 3)
            or (Grid.previous_move == 0 and Grid.orientation == 2)
            or (Grid.previous_move == 2 and Grid.orientation == 0)
        ):
