...
class Canvas:
    ...
    def calculate_orientation(self) -> None:
        ...
        if (
            ...
            or (Canvas.previous_move == 1 and Canvas.orientation == 1)
            or (Canvas.previous_move == 2 and Canvas.orientation == 3)
            or (Canvas.previous_move == 3 and Canvas.orientation == 2)
            or (Canvas.previous_move == 0 and Canvas.orientation == 0)
        ):
            self.set_orientation(1)
        elif (
            (Canvas.previous_move == 2 and Canvas.orientation == 1)
            or (Canvas.previous_move == 0 and Canvas.orientation == 3)
            or (Canvas.previous_move == 1 and Canvas.orientation == 2)
            or (Canvas.previous_move == 3 and Canvas.orientation == 0)
        ):
            self.set_orientation(2)
        elif (
            (Canvas.previous_move == 0 and Canvas.orientation == 1)
            or (Canvas.previous_move == 3 and Canvas.orientation == 3)
            or (Canvas.previous_move == 2 and Canvas.orientation == 2)
            or (Canvas.previous_move == 1 and Canvas.orientation == 0)
        ):
            self.set_orientation(0)
        elif (
            (Canvas.previous_move == 3 and Canvas.orientation == 1)
            or (Canvas.previous_move == 1 and Canvas.orientation == 3)
            or (Canvas.previous_move == 0 and Canvas.orientation == 2)
            or (Canvas.previous_move == 2 and Canvas.orientation == 0)
        ):
    ...
    def draw_sensors(self) -> None:
        ...
        for sensor in Canvas.sensors:
            ...
            self.context.set_source_rgb(0, 128, 0)
            self.context.fill_preserve()
            self.context.set_source_rgb(0, 0, 0)
            self.context.set_line_width(0.01)
            self.context.stroke()
    ...
    def calculate_connector_to_parent_position(self) -> (float, float):
        ...
        if (
            (Canvas.previous_move == 1 and parent_orientation == 1)
            or (Canvas.previous_move == 3 and parent_orientation == 2)
            or (Canvas.previous_move == 0 and parent_orientation == 0)
            or (Canvas.previous_move == 2 and parent_orientation == 3)
        ):
            # Connector is on top of parent
            return parent[0] + 0.5, parent[1]
        elif (
            (Canvas.previous_move == 2 and parent_orientation == 1)
            or (Canvas.previous_move == 1 and parent_orientation == 2)
            or (Canvas.previous_move == 3 and parent_orientation == 0)
            or (Canvas.previous_move == 0 and parent_orientation == 3)
        ):
            # Connector is on right side of parent
            return parent[0] + 1, parent[1] + 0.5
        elif (
            (Canvas.previous_move == 3 and parent_orientation == 1)
            or (Canvas.previous_move == 0 and parent_orientation == 2)
            or (Canvas.previous_move == 2 and parent_orientation == 0)
            or (Canvas.previous_move == 1 and parent_orientation == 3)
        ):
            # Connector is on left side of parent
            return parent[0], parent[1] + 0.5
        elif (
            (Canvas.previous_move == 0 and parent_orientation == 1)
            or (Canvas.previous_move == 2 and parent_orientation == 2)
            or (Canvas.previous_move == 1 and parent_orientation == 0)
            or (Canvas.previous_move == 3 and parent_orientation == 3)
        ):
