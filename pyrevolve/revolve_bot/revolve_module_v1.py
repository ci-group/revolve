...
class RevolveModule:
    ...
    def FromYaml(yaml_object):
        """
        From a yaml object, creates a data structure of interconnected body modules.
    ...
    def to_urdf(self, tree_depth='', parent_link=None, child_link=None):
        ...
        """
        name = 'component_{}_{}__box'.format(tree_depth, self.TYPE)
        visual = URDF.Visual(name, self.color())
...
class CoreModule(RevolveModule):
    ...
    """
    TYPE = "CoreComponent"
    VISUAL_MESH = 'model://rg_robot/meshes/CoreComponentV1.dae'
...
class ActiveHingeModule(RevolveModule):
    ...
    """
    TYPE = 'ActiveHinge'
    VISUAL_MESH_FRAME = 'model://rg_robot/meshes/ActiveHinge_FrameV1.dae'
    VISUAL_MESH_SERVO = 'model://rg_robot/meshes/ActiveCardanHinge_Servo_HolderV1.dae'
    ...
    def to_sdf(self, tree_depth='', parent_link=None, child_link=None):
        ...
        joint = SDF.Joint(self.id,
                          ...
                          parent_link,
                          child_link,
                          lower_limit=-7.853982e-01,
                          upper_limit=7.853982e-01,
                          effort_limit=1.765800e-01,
                          velocity_limit=5.235988e+00,
    ...
    def to_urdf(self, tree_depth='', parent_link=None, child_link=None):
        ...
        joint.set_position(URDF.math.Vector3(-0.0085, 0, 0))
...
class BrickModule(RevolveModule):
    ...
    """
    TYPE = "FixedBrick"
    VISUAL_MESH = 'model://rg_robot/meshes/FixedBrickV1.dae'
