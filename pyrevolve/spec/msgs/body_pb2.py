...
BodyPart = _reflection.GeneratedProtocolMessageType('BodyPart', (_message.Message,), {
...
BodyConnection = _reflection.GeneratedProtocolMessageType('BodyConnection', (_message.Message,), {
