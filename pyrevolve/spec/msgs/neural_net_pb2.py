...
NeuralConnection = _reflection.GeneratedProtocolMessageType('NeuralConnection', (_message.Message,), {
...
ModifyNeuralNetwork = _reflection.GeneratedProtocolMessageType('ModifyNeuralNetwork', (_message.Message,), {
