...
from pyrevolve.genotype.hyperplasticoding_neatspecies.initialization import random_initialization
from pyrevolve.genotype.hyperplasticoding_neatspecies.hyperplasticoding import HyperPlasticodingConfig
...
async def run():
    ...
    cppn_config_path = 'pyrevolve/genotype/hyperplasticoding_neatspecies/config-nonplastic'
