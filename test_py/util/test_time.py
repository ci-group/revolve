...
class TestTime(unittest.TestCase):
    ...
    def test_create(self):
        ...
        self.assertEqual(a.nsec, 1e9 - 10)
    ...
    def test_add(self):
        ...
        self.assertEqual(a.nsec, 1e8)

    def test_subtract(self):
        a = Time(5, 5e8)
        b = a - Time(4, 6 * 1e8)
        self.assertEqual(b.sec, 0)
        self.assertEqual(b.nsec, 9e8)

        b = a - 1.1
        self.assertEqual(b.sec, 4)
        self.assertEqual(b.nsec, 4e8)
    ...
    def test_eq(self):
        ...
        self.assertEqual(a, Time(5, 5e8))
        self.assertNotEqual(a, Time(5, 6e8))
