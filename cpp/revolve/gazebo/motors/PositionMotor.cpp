...
namespace revolve
{
  namespace gazebo
  {
            ...
            , noise_(0)
    {
      ...
      // http://answers.gazebosim.org/question/9071/
      // joint-target-velocity-with-maximum-force/
      // Until it is answered I'm resorting to calling ODE functions directly to
      // get this
      // to work. This will result in some deprecation warnings.
      // It has the added benefit of not requiring the world update connection
      // though.
...
// }
    void PositionMotor::update(double *outputs,
                               double /*step*/)
    {
