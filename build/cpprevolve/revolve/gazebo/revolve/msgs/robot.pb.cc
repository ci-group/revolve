...
static bool descriptor_table_robot_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_robot_2eproto = {
  &descriptor_table_robot_2eproto_initialized, descriptor_table_protodef_robot_2eproto, "robot.proto", 156,
...
static bool dynamic_init_dummy_robot_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_robot_2eproto), true);
namespace revolve {
namespace msgs {
