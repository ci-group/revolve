...
set(CPACK_PACKAGE_NAME "tol-revolve")

if(APPLE)
  set(CPACK_PACKAGE_VENDOR "VUAmsterdam") # PackageMaker doesn't like http://
else()
  set(CPACK_PACKAGE_VENDOR "http://evosphere.eu/") # deb lintian insists on URL
endif()

set(CPACK_PACKAGE_DESCRIPTION_SUMMARY "Revolve project")
set(CPACK_PACKAGE_CONTACT "Milan Jelisavcic <milan.jelisavcic@gmail.com>")
