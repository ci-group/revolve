...
template <typename T>
void GAM_UncorrelatedNStepSizeBoundary(galgo::CHR< T > &chr, size_t current_iteration)
{
...
//  std::cout << "std_dev: " << std_dev << std::endl;
  std::normal_distribution< double > distribution01(0.0, std_dev); //ea:0.4, boea:0.2
