...
revolve::DifferentialCPG::ControllerParams DifferentialCPG::load_params_from_sdf(sdf::ElementPtr brain_sdf)
{
    ...
    if (controller_sdf == nullptr) throw std::runtime_error("Controller element not found when reading CPG parameters");
...
//    params.use_frame_of_reference =
    ...
    params.output_signal_factor = stod(controller_sdf->GetAttribute("signal_factor_all")->GetAsString());
