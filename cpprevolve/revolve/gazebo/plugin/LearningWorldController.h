...
#ifndef REVOLVE_LEARNINGWORLDCONTROLLER_H
#define REVOLVE_LEARNINGWORLDCONTROLLER_H
...
namespace revolve {
    namespace gazebo {
        ...
        class LearningWorldController: public ::gazebo::WorldPlugin
        {
        public:
            LearningWorldController();

            virtual ~LearningWorldController();
...
#endif  // REVOLVE_LearningWorldController_H
