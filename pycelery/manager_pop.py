...
""" I USE THIS FILE JUST TO SEE WHAT I NEED TO ADD TO THE CELERYCONTROLLER CLASS
    ATTENTION: THIS FILE MAY NOT BE RUNNABLE, AND WILL BE DELETED IN THE FUTURE. - Sam Ferwerda"""
...
async def run():
    ...
    """Experiment mananger also in MANAGER FILE"""
    ...
    """ CREATE THE POPULATION TO TEST, also manager"""
    ...
    """ This part is not necesary with celery"""
