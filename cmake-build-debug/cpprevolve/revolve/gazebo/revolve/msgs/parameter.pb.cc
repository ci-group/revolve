...
const Parameter& Parameter::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_parameter_2eproto::scc_info_Parameter.base);
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::revolve::msgs::Parameter* Arena::CreateMaybeMessage< ::revolve::msgs::Parameter >(Arena* arena) {
  return Arena::CreateInternal< ::revolve::msgs::Parameter >(arena);
}
}  // namespace protobuf
}  // namespace google
