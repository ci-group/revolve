...
#ifndef PROTOBUF_INCLUDED_robot_5fstates_2eproto
#define PROTOBUF_INCLUDED_robot_5fstates_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_robot_5fstates_2eproto 
...
class RobotStates : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:revolve.msgs.RobotStates) */ {
 public:
  ...
  inline RobotStates* New() const final {
    return CreateMaybeMessage<RobotStates>(NULL);
  }

  RobotStates* New(::google::protobuf::Arena* arena) const final {
...
inline void RobotState::set_has_dead() {
  _has_bits_[0] |= 0x00000008u;
}
inline void RobotState::clear_has_dead() {
  _has_bits_[0] &= ~0x00000008u;
}
...
#endif  // PROTOBUF_INCLUDED_robot_5fstates_2eproto
