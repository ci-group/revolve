...
extern PROTOBUF_INTERNAL_EXPORT_protobuf_body_2eproto ::google::protobuf::internal::SCCInfo<1> scc_info_BodyConnection;
}  // namespace protobuf_body_2eproto
...
::google::protobuf::internal::SCCInfo<1> scc_info_BodyConnection =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsBodyConnection}, {
...
::google::protobuf::internal::SCCInfo<1> scc_info_Body =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsBody}, {
      &protobuf_body_2eproto::scc_info_BodyConnection.base,}};
...
const BodyPart& BodyPart::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_body_2eproto::scc_info_BodyConnection.base);
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::revolve::msgs::BodyPart* Arena::CreateMaybeMessage< ::revolve::msgs::BodyPart >(Arena* arena) {
  return Arena::CreateInternal< ::revolve::msgs::BodyPart >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::revolve::msgs::BodyConnection* Arena::CreateMaybeMessage< ::revolve::msgs::BodyConnection >(Arena* arena) {
  return Arena::CreateInternal< ::revolve::msgs::BodyConnection >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::revolve::msgs::Body* Arena::CreateMaybeMessage< ::revolve::msgs::Body >(Arena* arena) {
